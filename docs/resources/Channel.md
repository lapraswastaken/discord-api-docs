...
| available_tags?                     | array of [forum tag](#DOCS_RESOURCES_CHANNEL/forum-tag-object) objects      | the set of tags that can be used in a `GUILD_FORUM` channel                                                                                                                                   |
...
| referenced_message?\*\*\*\* | ?[message](#DOCS_RESOURCES_CHANNEL/message-object) object                                                                          | the message associated with the message_reference                                                                                                                                                                                                                        |
| interaction?                | [message interaction](#DOCS_INTERACTIONS_RECEIVING_AND_RESPONDING/message-interaction-object-message-interaction-structure) object | sent if the message is a response to an [Interaction](#DOCS_INTERACTIONS_RECEIVING_AND_RESPONDING/)                                                                                                                                                                      |
...
| sticker_items?              | array of [sticker item](#DOCS_RESOURCES_STICKER/sticker-item-object) objects                                               | sent if the message contains stickers                                                                                                                                                                                                                                    |
...
| type?        | string                                                                                     | [type of embed](#DOCS_RESOURCES_CHANNEL/embed-object-embed-type-strings) (always "rich" for webhook embeds) |
...
| allowed_mentions?  | [allowed mentions object](#DOCS_RESOURCES_CHANNEL/allowed-mentions-object)                         | Allowed mentions for the message                                                                                                                                            |
